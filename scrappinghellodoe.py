# -*- coding: utf-8 -*-
"""ScrappingHelloDoe.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ANaEOFIUnmfJ_-xMuw26S9u0DOViCBZn
"""
...
def scrapperJobDescription(url1):
    print('in')
...
def CSVcreation(ListMission):
    ...
    if os.path.isdir('gdrive/MyDrive/HelloDoeScrapper/'):
        print("Fichier HelloDoeScrapper existant")
    else:
        os.mkdir('gdrive/MyDrive/HelloDoeScrapper/')
